    ...
    private void setUpBaseView() {
        ...
        if(userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                ...
                try {
                    Glide.with(getContext()).load(message.getStringAttribute("MESSAGE_ATTR_FORM_PIC")).into(userAvatarView);
                    EaseUserUtils.setUserNick(message.getStringAttribute("MESSAGE_ATTR_FORM_NICK"), usernickView);
